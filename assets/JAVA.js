...
function openRemitlyWithCharlestDetails() {
    // Direct link to Remitly send page with Charles's pre-filled information
    const remitlyUrl = new URL('https://www.remitly.com/send');
    remitlyUrl.searchParams.append('recipientName', 'Ssebuliba Charles');
    remitlyUrl.searchParams.append('country', 'UG');
    remitlyUrl.searchParams.append('city', 'MITYANA');
    remitlyUrl.searchParams.append('phoneNumber', '+256 768 170 144');
    remitlyUrl.searchParams.append('address', 'MARKET STREET');
    remitlyUrl.searchParams.append('deliveryMethod', 'MOBILE_MONEY');
    remitlyUrl.searchParams.append('mobileWallet', 'MTN');
    
    window.open(remitlyUrl.toString(), '_blank');
}
...
Thank you for supporting God's_will_ministry Uganda! 🇺🇬
    ...
    alert(recipientInfo);
    openRemitlyWithCharlestDetails();
}
